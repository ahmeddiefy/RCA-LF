...
%%% converting the extracted light field to a different format
    ...
    input_small(:,:,1,1) = fullLF(:,:,3,3);
    input_small(:,:,1,2) = fullLF(:,:,3,6);
    
    input_small(:,:,2,1) = fullLF(:,:,6,3);
    input_small(:,:,2,2) = fullLF(:,:,6,6);
    ...
    input_small_2(:,:,3,3) = fullLF(:,:,3,3);
    input_small_2(:,:,3,6) = fullLF(:,:,3,6);

    input_small_2(:,:,6,3) = fullLF(:,:,6,3);
    input_small_2(:,:,6,6) = fullLF(:,:,6,6);
